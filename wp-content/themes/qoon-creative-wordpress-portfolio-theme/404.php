...
<h1 class="text-center" style="color: #fff;"><?php _e('Oops, 404 Error','qoon-creative-wordpress-portfolio-theme');?></h1>
<h5 style="color: #fff;"><?php _e('The page you were looking for could not be found.','qoon-creative-wordpress-portfolio-theme');?></h5>
<br>
