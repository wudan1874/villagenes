 ...
 */
	...
	function OrangeIdea_Twitter_Widget() {
		...
		/* Widget settings. */
		$widget_ops = array('classname' => 'OrangeIdea_twitter_widget', 'description' => __( 'OrangeIdea: Twitter', 'qoon-creative-wordpress-portfolio-theme' ) );
...
function form( $instance ) {
	...
	$defaults = array( 
		'title' => __( 'Twitter Widget' , 'qoon-creative-wordpress-portfolio-theme' ),
    ...
    <p>
		<label for="<?php echo $this->get_field_id( 'oi_consumer_key' ); ?>"><?php _e('Consumer Key:', 'qoon-creative-wordpress-portfolio-theme') ?></label>
    ...
    <p>
		<label for="<?php echo $this->get_field_id( 'oi_consumer_secret' ); ?>"><?php _e('Consumer Secret:', 'qoon-creative-wordpress-portfolio-theme') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'oi_user_token' ); ?>"><?php _e('User Token:', 'qoon-creative-wordpress-portfolio-theme') ?></label>
    ...
    <p>
		<label for="<?php echo $this->get_field_id( 'oi_user_secret' ); ?>"><?php _e('User Secret:', 'qoon-creative-wordpress-portfolio-theme') ?></label>
    ...
    <p>
		<label for="<?php echo $this->get_field_id( 'oi_account' ); ?>"><?php _e('Twitter Username:', 'qoon-creative-wordpress-portfolio-theme') ?></label>
    ...
    <p>
		<label for="<?php echo $this->get_field_id( 'oi_account_count' ); ?>"><?php _e('Amount of tweets:', 'qoon-creative-wordpress-portfolio-theme') ?></label>
