...
function oi_custom_slider_f( $atts, $content = null)
{
	...
	$output .='<style>';
		...
		$output .='.owl-nav .owl-prev, .owl-nav .owl-next { margin-top:'.$oi_slider_nav_m.'; } ';
		$output .='.owl-nav .owl-prev, .owl-nav .owl-next i {color:'.$oi_slider_nav_c.'}';
	$output .='</style>';
	
	$output .='<div data-icon-size="'.$oi_slider_nav_s.'" data-color-hover="'.$oi_slider_nav_ch.'" data-arrows="'.$arrow_nav.'"  data-color="'.$oi_slider_nav_c.'" class="oi_owl_slider" id="'.$oi_id.'">'.do_shortcode($content).'</div>';
	$output .='<script>
...
vc_map( array(
    ...
    "as_parent" => array('only' => 'vc_testimonial_item, vc_portfolio_item, oi_partner, vc_portfolio_item_fh'), // Use only|except attributes to limit child shortcodes (separate multiple values with comma)
    ...
    "params" => array(
		array(
			...
			"description" => __( "Please set slider ID", 'maxcode-pure-portfolio-and-business-theme' )
		),
		array(
			'type' => 'dropdown',
			'heading' => "Autoplay",
		...
		array(
			...
			"value" => '100px',
			"description" => __( "Size in px", 'maxcode-pure-portfolio-and-business-theme' )
		),
		array(
			"type" => "textfield",
			"holder" => "div",
		...
		array(
			...
			"value" => '1',
			"description" => __( "For big desktops", 'maxcode-pure-portfolio-and-business-theme' )
		),
		array(
			"type" => "textfield",
			"holder" => "div",
		...
		array(
			...
			"value" => '1',
			"description" => __( "For standard desktops", 'maxcode-pure-portfolio-and-business-theme' )
		),
		array(
			"type" => "textfield",
			"holder" => "div",
		...
		array(
			...
			"value" => '1',
			"description" => __( "For landscape tablet view", 'maxcode-pure-portfolio-and-business-theme' )
		),
		array(
			"type" => "textfield",
			"holder" => "div",
		...
		array(
			...
			"value" => '1',
			"description" => __( "For portrait tablet view", 'maxcode-pure-portfolio-and-business-theme' )
		),
		array(
			"type" => "textfield",
			"holder" => "div",
		...
		array(
			...
			"value" => '1',
			"description" => __( "For mobile", 'maxcode-pure-portfolio-and-business-theme' )
		),
		array(
			"type" => "textfield",
			"holder" => "div",
