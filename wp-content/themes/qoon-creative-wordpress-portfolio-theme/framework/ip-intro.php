<?php // Template Name: IP Intro Template ?>
<?php get_header();?>
<?php
    ...
    <?php  if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
        ...
        <!-- ========================Page Content Start Here========================= -->
         ...
         <div class="xx_ip_member" >
                       <img src="<?php echo wp_upload_dir()['baseurl']; ?>/2017/12/ip-member-intro-bg-v2.jpg">
                       <div class="" style="position: absolute;right: 43%;bottom: 15%;text-align:center;">
