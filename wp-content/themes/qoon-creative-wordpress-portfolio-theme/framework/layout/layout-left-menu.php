...
<div class="visible-sm visible-xs visible-md" id="menu_slide_xs"><a id="nav-toggle" href="#"><span></span></a></div>
...
<div class="oi_header_side oi_full_page">
	...
	if (qoon_is_blog() || is_search()){
		...
		if($ptype == 'portfolio' || $ptype == 'news_programmes')
		{
			$feat_image =  wp_upload_dir()['baseurl'] .'/2017/12/home-bg.jpg';
		}
		else{
			$feat_image = wp_get_attachment_url( get_post_thumbnail_id($post->ID) ); 
		}
    ...
    <?php }else{?>
    <div class="oi_image_logo"><div class="test" style="text-align: center"><a href="<?php echo esc_url(home_url('/')); ?>" class="oi_text_logo_img"><img src="<?php echo esc_url($oi_qoon_options['oi_logo_upload']['url'])?>" alt="<?php echo esc_attr(bloginfo('name'));?>" style="max-width: 150px;max-height: 204px;"/></a></div></div>
    <?php };?>
