...
function oi_partner_f( $atts, $content = null)
{
	...
	if($title==''){
		$output ='<div class="oi_partner_holder"><a target="'.$oi_target.'" href="'.$url.'">'.$image_done.'</a></div>';
	}else{
...
vc_map( array(
   "name" => __("Partner logo",'maxcode-pure-portfolio-and-business-theme'),
   "base" => "oi_partner",
   "class" => "",
   ...
   "params" => array(
	  array(
         "type" => "attach_image",
         "class" => "",
         "heading" => __("logo",'maxcode-pure-portfolio-and-business-theme'),
         "param_name" => "image",
         "value" => "",
      ),
	  array(
         "type" => "textfield",
         "class" => "",
         "heading" => __("URL",'maxcode-pure-portfolio-and-business-theme'),
         "param_name" => "url",
