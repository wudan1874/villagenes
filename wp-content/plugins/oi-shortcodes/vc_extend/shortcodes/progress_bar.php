...
function oi_progress_f( $atts, $content = null)
{
	...
	<div style="position:relative">
		<div class="oi_progress_value" style="width:'.$oi_progress_value.'%; "><span>'.$oi_progress_value.'%</span></div>
...
vc_map( array(
   "name" => __("Progress Bar",'maxcode-pure-portfolio-and-business-theme'),
   "base" => "oi_progress",
   "class" => "",
   ...
   "params" => array(
	  array(
         "type" => "textfield",
         "class" => "",
         "heading" => __("Progress Value",'maxcode-pure-portfolio-and-business-theme'),
	  ...
	  array(
         "type" => "textfield",
         "class" => "",
         "heading" => __("Progress Height",'maxcode-pure-portfolio-and-business-theme'),
	  ...
	  array(
         "type" => "textfield",
         "class" => "",
         "heading" => __("Progress Border Radius",'maxcode-pure-portfolio-and-business-theme'),
	  ...
	  array(
         "type" => "textfield",
         "class" => "",
         "heading" => __("Title",'maxcode-pure-portfolio-and-business-theme'),
